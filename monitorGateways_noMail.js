...
let monitorMainnetGatewayUrls = [
                                    ...
                                    ,{url: 'http://18.195.163.229:8932', alias: 'Mainnet Frankfurt'}
...
for (let i = 0; i < blockHeights.length; i++){
    ...
    console.log(monitorTestnetGatewayUrls[i].alias, blockHeights[i]);
}
...
for (let i = 0; i < blockHeights.length; i++){
    ...
    console.log(monitorMainnetGatewayUrls[i].alias, blockHeights[i]);
}
